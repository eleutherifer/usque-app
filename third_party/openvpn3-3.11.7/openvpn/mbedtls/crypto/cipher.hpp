    ...
    : public CipherContextCommon
{
  ...
  public:
              ...
              const int mode)
    {
        ...
        initialized = true;
        // Mbed TLS 3.6.7 requires explicit CBC padding selection. OpenVPN's
        // CBC data channel uses PKCS#7, including on block-aligned packets.
